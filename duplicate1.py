...
# df = pd.read_csv(r"C:\Users\ACER\Desktop\myProj\Facial-Recognition-Based-Student-Attendance-System\custompmc.csv", header=None)
df = pd.read_csv(r"Teampmc23.csv", header=None)
