...
class Face_Recognition:
    ...
    def mark_attendance(self,i,r,n,d):
        with open("Teampmc23.csv","r+",newline="\n") as f:
            ...
            if((i not in name_list) and (r not in name_list) and (n not in name_list) and (i not in name_list)):
                ...
                # DF_RM_DUP.write_csv(r"E:\6th sem\my_project\Face_reg\face_recognize_student_attendence_system\Teampmc1.csv")
...
#    .............. # [[  data = DF_RM_DUP.head(n=1)
    # #    ((((((Pahilaaa koooo yo)))))) # data.to_csv('teampmc1.csv',encoding='utf-8', index=True)
    ...
    #     df_state=pd.read_csv(r"E:\6th sem\my_project\Face_reg\face_recognize_student_attendence_system\Teampmc2.csv")
